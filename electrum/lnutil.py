...
@attr.s
class ChannelBackup(StoredObject):
    ...
    local_seed = attr.ib(type=bytes, converter=hex_to_bytes)
    ...
    def to_bytes(self):
        ...
        vds.write_bytes(self.local_seed, 32)
    ...
    def from_bytes(s):
        ...
        return ChannelBackup(
            ...
            local_seed = vds.read_bytes(32).hex(),
